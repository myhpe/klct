...
def get_user(conn, user_dn, user_id_attribute, objectclass, user_name_attribute, name):
    ...
    try:
        ...
        if conn.search(search_base=user_dn, search_filter=search_filter, attributes=[user_id_attribute]) is True:
...
def get_group(conn, group_dn, group_id_attribute, objectclass, group_name_attribute, name):
    ...
    try:
        ...
        if conn.search(search_base=group_dn, search_filter=search_filter, attributes=[group_id_attribute]) is True:
